...
public class AddCommandSystemTest extends AddressBookSystemTest {
    ...
    public void add() throws Exception {
        ...
        String command = "   " + AddCommand.COMMAND_WORD + "  " + NAME_DESC_AMY + "  " + PHONE_DESC_AMY + " "
                + EMAIL_DESC_AMY + "   " + ADDRESS_DESC_AMY + "   " + DOB_DESC_AMY + " " + " " + IMAGE_BOB
                + REMARK_DESC_AMY + " "
                + TAG_DESC_FRIEND + " ";
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_AMY + DOB_DESC_AMY + REMARK_DESC_AMY + IMAGE_AMY
                + TAG_DESC_FRIEND;
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + DOB_DESC_AMY + REMARK_DESC_AMY + IMAGE_AMY
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withDateOfBirth(VALID_DOB_AMY).withTags(VALID_TAG_FRIEND)
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_AMY).withDateOfBirth(VALID_DOB_AMY).withImage(VALID_IMAGE_AMY)
        ...
        toAdd = new PersonBuilder().withName(VALID_NAME_AMY).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY)
                .withAddress(VALID_ADDRESS_BOB).withDateOfBirth(VALID_DOB_AMY).withImage(VALID_IMAGE_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY
                + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_BOB + DOB_DESC_AMY + REMARK_DESC_AMY + IMAGE_AMY
                + TAG_DESC_FRIEND;
        assertCommandSuccess(command, toAdd);
        ...
        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + ADDRESS_DESC_BOB
                + NAME_DESC_BOB + DOB_DESC_BOB + REMARK_DESC_BOB + IMAGE_BOB
        ...
        /* Case: missing dateOfBirth -> rejected 
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + EMAIL_DESC_AMY + PHONE_DESC_AMY + ADDRESS_DESC_AMY;
        assertCommandFailure(command, String.format(MESSAGE_INVALID_COMMAND_FORMAT, AddCommand.MESSAGE_USAGE));
        ...
        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + INVALID_ADDRESS_DESC + DOB_DESC_AMY + REMARK_DESC_AMY + IMAGE_AMY;
...
//        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY
//                + PHONE_DESC_AMY + EMAIL_DESC_AMY + ADDRESS_DESC_BOB + DOB_DESC_AMY + REMARK_DESC_AMY
//                + TAG_DESC_FRIEND;
//        assertCommandSuccess(command, toAdd);
//
//        /* Case: filters the person list before adding -> added */
...
//        toAdd = BOB;
//        command = AddCommand.COMMAND_WORD + TAG_DESC_FRIEND + PHONE_DESC_BOB + ADDRESS_DESC_BOB
//                + NAME_DESC_BOB + DOB_DESC_BOB + REMARK_DESC_BOB
//                + TAG_DESC_HUSBAND + EMAIL_DESC_BOB;
//        assertCommandSuccess(command, toAdd);
//
//        /* Case: selects first card in the person list, add a person -> added, card selection remains unchanged */
...
//        /* Case: invalid address -> rejected */
//        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
//                + INVALID_ADDRESS_DESC + DOB_DESC_AMY + REMARK_DESC_AMY;
//        assertCommandFailure(command, Address.MESSAGE_ADDRESS_CONSTRAINTS);
//
//        /* Case: invalid tag -> rejected */
//        command = AddCommand.COMMAND_WORD + NAME_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY
